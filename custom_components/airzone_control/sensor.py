...
def _build_cloud_energy_meter_sensors(coord: AirzoneCoordinator, meter_id: str) -> List[SensorEntity]:
    ...
    specs = (
        ("energy_hour_latest", "Imported energy (last hour)", "kWh", "energy", None),
        ("energy_hour_total", "Imported energy total", "kWh", "energy", SensorStateClass.TOTAL_INCREASING),
        ...
        ("energy_acc", "Imported energy (last hour)", "kWh", "energy", None),
        ("energy_ret", "Returned energy (last hour)", "kWh", "energy", None),
        ("energy1_acc", "Imported energy P1 (last hour)", "kWh", "energy", None),
        ("energy1_ret", "Returned energy P1 (last hour)", "kWh", "energy", None),
        ("energy2_acc", "Imported energy P2 (last hour)", "kWh", "energy", None),
        ("energy2_ret", "Returned energy P2 (last hour)", "kWh", "energy", None),
        ("energy3_acc", "Imported energy P3 (last hour)", "kWh", "energy", None),
        ("energy3_ret", "Returned energy P3 (last hour)", "kWh", "energy", None),
        ("energy_acc_total", "Imported energy total", "kWh", "energy", SensorStateClass.TOTAL_INCREASING),
        ("energy_ret_total", "Returned energy total", "kWh", "energy", SensorStateClass.TOTAL_INCREASING),
        ("energy1_acc_total", "Imported energy P1 total", "kWh", "energy", SensorStateClass.TOTAL_INCREASING),
        ("energy1_ret_total", "Returned energy P1 total", "kWh", "energy", SensorStateClass.TOTAL_INCREASING),
        ("energy2_acc_total", "Imported energy P2 total", "kWh", "energy", SensorStateClass.TOTAL_INCREASING),
        ("energy2_ret_total", "Returned energy P2 total", "kWh", "energy", SensorStateClass.TOTAL_INCREASING),
        ("energy3_acc_total", "Imported energy P3 total", "kWh", "energy", SensorStateClass.TOTAL_INCREASING),
        ("energy3_ret_total", "Returned energy P3 total", "kWh", "energy", SensorStateClass.TOTAL_INCREASING),
        ...
        ("power_total", "Power", "W", "power", SensorStateClass.MEASUREMENT),
        ("power_p1", "Power P1", "W", "power", SensorStateClass.MEASUREMENT),
        ("power_p2", "Power P2", "W", "power", SensorStateClass.MEASUREMENT),
        ("power_p3", "Power P3", "W", "power", SensorStateClass.MEASUREMENT),
